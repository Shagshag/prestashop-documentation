...
* Source: [controllers/admin/AdminWarehousesController.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminWarehousesController.php#L31)
...
* Visibility: **public**
* Source: [controllers/admin/AdminWarehousesController.php line 33](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminWarehousesController.php#L33)
...
```php
mixed AdminWarehousesControllerCore::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminWarehousesController.php line 127](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminWarehousesController.php#L127)
...
```php
mixed AdminWarehousesControllerCore::initList()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminWarehousesController.php line 82](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminWarehousesController.php#L82)
...
```php
mixed AdminWarehousesControllerCore::initView()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminWarehousesController.php line 449](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminWarehousesController.php#L449)
...
* Visibility: **public**
* Source: [controllers/admin/AdminWarehousesController.php line 371](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminWarehousesController.php#L371)
