...
* Class name: AdminImagesController
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminImagesController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImagesController.php#L28)
...
* Visibility: **private**
* Source: [controllers/admin/AdminImagesController.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImagesController.php#L31).
...
* Visibility: **private**
* Source: [controllers/admin/AdminImagesController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImagesController.php#L30).
...
```php
mixed AdminImagesController::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImagesController.php line 33](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImagesController.php#L33)
...
```php
mixed AdminImagesController::_childValidation()
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminImagesController.php line 288](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImagesController.php#L288)
...
```php
mixed AdminImagesController::_deleteOldImages($dir, $type, $product)
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminImagesController.php line 321](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImagesController.php#L321)
...
```php
mixed AdminImagesController::_moveImagesToNewFileSystem()
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminImagesController.php line 510](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImagesController.php#L510)
...
```php
mixed AdminImagesController::_regenerateNewImages($dir, $type, $productsImages)
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminImagesController.php line 354](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImagesController.php#L354)


#### Arguments
* $dir **mixed**
* $type **mixed**
* $productsImages **mixed**
...
```php
mixed AdminImagesController::_regenerateNoPictureImages($dir, $type, $languages)
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminImagesController.php line 400](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImagesController.php#L400)
...
```php
mixed AdminImagesController::_regenerateThumbnails($type, $deleteOldImages)
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminImagesController.php line 443](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImagesController.php#L443)
...
```php
mixed AdminImagesController::_regenerateWatermark($dir)
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminImagesController.php line 417](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImagesController.php#L417)
...
```php
mixed AdminImagesController::initContent()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImagesController.php line 527](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImagesController.php#L527)
...
```php
mixed AdminImagesController::initMoveImages()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImagesController.php line 499](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImagesController.php#L499)
...
```php
mixed AdminImagesController::initRegenerate()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImagesController.php line 297](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImagesController.php#L297)
...
```php
mixed AdminImagesController::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImagesController.php line 235](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImagesController.php#L235)
