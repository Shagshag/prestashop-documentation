Class AdminStatsConfControllerCore
=====================
...
* Class name: AdminStatsConfControllerCore
* Parent class: [AdminPreferencesControllerCore](class.AdminPreferencesControllerCore.md)
* Source: [controllers/admin/AdminStatsConfController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStatsConfController.php#L28)
...
```php
mixed AdminStatsConfControllerCore::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatsConfController.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStatsConfController.php#L31)
...
```php
mixed AdminStatsConfControllerCore::beforeUpdateOptions()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatsConfController.php line 353](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStatsConfController.php#L353)
...
```php
mixed AdminStatsConfControllerCore::getConf($fields, $languages)
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminStatsConfController.php line 341](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStatsConfController.php#L341)
...
```php
mixed AdminStatsConfControllerCore::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatsConfController.php line 335](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStatsConfController.php#L335)
...
```php
mixed AdminStatsConfControllerCore::updateOptionPsAttachementMaximumSize($value)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatsConfController.php line 367](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStatsConfController.php#L367)
