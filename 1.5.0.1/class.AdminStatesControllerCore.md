...
* Source: [controllers/admin/AdminStatesController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStatesController.php#L28)
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatesController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStatesController.php#L30)
...
```php
mixed AdminStatesControllerCore::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatesController.php line 65](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStatesController.php#L65)
...
```php
mixed AdminStatesControllerCore::initList()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatesController.php line 57](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStatesController.php#L57)
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatesController.php line 149](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStatesController.php#L149)
