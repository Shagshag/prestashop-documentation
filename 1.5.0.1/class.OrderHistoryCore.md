...
* Source: [classes/order/OrderHistory.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderHistory.php#L28)
...
* Visibility: **public**
* Source: [classes/order/OrderHistory.php line 40](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderHistory.php#L40).
...
* Visibility: **public**
* Source: [classes/order/OrderHistory.php line 43](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderHistory.php#L43).


### <a name="property-$fieldsRequired"></a>$fieldsRequired

```php
protected mixed $fieldsRequired = array('id_order', 'id_order_state')
```
...
* Source: [classes/order/OrderHistory.php line 47](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderHistory.php#L47).


### <a name="property-$fieldsValidate"></a>$fieldsValidate

```php
protected mixed $fieldsValidate = array('id_order' => 'isUnsignedId', 'id_order_state' => 'isUnsignedId', 'id_employee' => 'isUnsignedId')
```
...
* Visibility: **protected**
* Source: [classes/order/OrderHistory.php line 48](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderHistory.php#L48).
...
* Visibility: **public**
* Source: [classes/order/OrderHistory.php line 37](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderHistory.php#L37).
...
* Visibility: **public**
* Source: [classes/order/OrderHistory.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderHistory.php#L31).
...
* Visibility: **public**
* Source: [classes/order/OrderHistory.php line 34](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderHistory.php#L34).


### <a name="property-$identifier"></a>$identifier

```php
protected mixed $identifier = 'id_order_history'
```
...
* Visibility: **protected**
* Source: [classes/order/OrderHistory.php line 51](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderHistory.php#L51).


### <a name="property-$table"></a>$table

```php
protected mixed $table = 'order_history'
```
...
* Visibility: **protected**
* Source: [classes/order/OrderHistory.php line 50](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderHistory.php#L50).


### <a name="property-$tables"></a>$tables

```php
protected mixed $tables = array('order_history')
```
...
* Visibility: **protected**
* Source: [classes/order/OrderHistory.php line 45](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderHistory.php#L45).


### <a name="property-$webserviceParameters"></a>$webserviceParameters

```php
protected mixed $webserviceParameters = array('objectsNodeName' => 'order_histories', 'fields' => array('id_order_state' => array('required' => true, 'xlink_resource' => 'order_states'), 'id_order' => array('xlink_resource' => 'orders')))
```
...
* Visibility: **protected**
* Source: [classes/order/OrderHistory.php line 53](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderHistory.php#L53).
...
```php
mixed OrderHistoryCore::addWithemail($autodate, $templateVars, \Context $context)
```
...
* Visibility: **public**
* Source: [classes/order/OrderHistory.php line 144](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderHistory.php#L144)
...
```php
mixed OrderHistoryCore::changeIdOrderState($new_order_state, $id_order, $id_warehouse)
```
...
* Visibility: **public**
* Source: [classes/order/OrderHistory.php line 73](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderHistory.php#L73)


#### Arguments
* $new_order_state **mixed**
* $id_order **mixed**
* $id_warehouse **mixed**
...
```php
mixed OrderHistoryCore::getFields()
```
...
* Visibility: **public**
* Source: [classes/order/OrderHistory.php line 61](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderHistory.php#L61)
...
```php
mixed OrderHistoryCore::getLastOrderState($id_order)
```
...
* Visibility: **public**
* This method is **static**.
* Source: [classes/order/OrderHistory.php line 132](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderHistory.php#L132)
...
```php
mixed OrderHistoryCore::isValidated()
```
...
* Visibility: **public**
* Source: [classes/order/OrderHistory.php line 212](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderHistory.php#L212)
