...
* Class name: AdminCatalogController
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminCatalogController.php line 29](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCatalogController.php#L29)
...
* [$attributeGenerator](#property-$attributeGenerator)
* [$imageResize](#property-$imageResize)
...
* [getCurrentCategory](#method-getCurrentCategory)
...
* Source: [controllers/admin/AdminCatalogController.php line 44](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCatalogController.php#L44).


### <a name="property-$attributeGenerator"></a>$attributeGenerator

```php
private object $attributeGenerator
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminCatalogController.php line 38](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCatalogController.php#L38).


### <a name="property-$imageResize"></a>$imageResize

```php
private object $imageResize
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminCatalogController.php line 41](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCatalogController.php#L41).
...
```php
mixed AdminCatalogController::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCatalogController.php line 46](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCatalogController.php#L46)
...
```php
mixed AdminCatalogController::ajaxProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCatalogController.php line 110](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCatalogController.php#L110)
...
```php
mixed AdminCatalogController::displayErrors()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCatalogController.php line 121](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCatalogController.php#L121)
...
### <a name="method-getCurrentCategory"></a>getCurrentCategory

```php
object AdminCatalogController::getCurrentCategory()
```
...
* Visibility: **public**
* This method is **static**.
* Source: [controllers/admin/AdminCatalogController.php line 84](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCatalogController.php#L84)
...
```php
mixed AdminCatalogController::initContent()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCatalogController.php line 132](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCatalogController.php#L132)
...
```php
mixed AdminCatalogController::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCatalogController.php line 97](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCatalogController.php#L97)
...
```php
mixed AdminCatalogController::viewAccess($disable)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCatalogController.php line 89](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCatalogController.php#L89)
