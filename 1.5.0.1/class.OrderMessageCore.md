...
* Source: [classes/order/OrderMessage.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderMessage.php#L28)
...
* Visibility: **public**
* Source: [classes/order/OrderMessage.php line 37](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderMessage.php#L37).
...
* Source: [classes/order/OrderMessage.php line 39](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderMessage.php#L39).


### <a name="property-$fieldsRequiredLang"></a>$fieldsRequiredLang

```php
protected mixed $fieldsRequiredLang = array('name', 'message')
```
...
* Visibility: **protected**
* Source: [classes/order/OrderMessage.php line 43](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderMessage.php#L43).
...
* Visibility: **protected**
* Source: [classes/order/OrderMessage.php line 41](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderMessage.php#L41).


### <a name="property-$fieldsSizeLang"></a>$fieldsSizeLang

```php
protected mixed $fieldsSizeLang = array('name' => 128, 'message' => 1200)
```
...
* Visibility: **protected**
* Source: [classes/order/OrderMessage.php line 44](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderMessage.php#L44).
...
* Visibility: **protected**
* Source: [classes/order/OrderMessage.php line 40](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderMessage.php#L40).


### <a name="property-$fieldsValidateLang"></a>$fieldsValidateLang

```php
protected mixed $fieldsValidateLang = array('name' => 'isGenericName', 'message' => 'isMessage')
```
...
* Visibility: **protected**
* Source: [classes/order/OrderMessage.php line 45](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderMessage.php#L45).


### <a name="property-$identifier"></a>$identifier

```php
protected mixed $identifier = 'id_order_message'
```
...
* Visibility: **protected**
* Source: [classes/order/OrderMessage.php line 48](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderMessage.php#L48).
...
* Visibility: **public**
* Source: [classes/order/OrderMessage.php line 34](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderMessage.php#L34).
...
* Visibility: **public**
* Source: [classes/order/OrderMessage.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderMessage.php#L31).


### <a name="property-$table"></a>$table

```php
protected mixed $table = 'order_message'
```
...
* Visibility: **protected**
* Source: [classes/order/OrderMessage.php line 47](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderMessage.php#L47).
...
* Visibility: **protected**
* Source: [classes/order/OrderMessage.php line 50](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderMessage.php#L50).
...
```php
mixed OrderMessageCore::getFields()
```
...
* Visibility: **public**
* Source: [classes/order/OrderMessage.php line 57](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderMessage.php#L57)
...
* Visibility: **public**
* This method is **static**.
* Source: [classes/order/OrderMessage.php line 69](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderMessage.php#L69)
...
```php
mixed OrderMessageCore::getTranslationsFieldsChild()
```
...
* Visibility: **public**
* Source: [classes/order/OrderMessage.php line 63](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderMessage.php#L63)
