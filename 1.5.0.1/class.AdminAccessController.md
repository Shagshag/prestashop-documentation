...
* Class name: AdminAccessController
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminAccessController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminAccessController.php#L28)
...
```php
mixed AdminAccessController::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccessController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminAccessController.php#L30)
...
```php
mixed AdminAccessController::ajaxProcessUpdateAccess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccessController.php line 102](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminAccessController.php#L102)
...
```php
mixed AdminAccessController::ajaxProcessUpdateModuleAccess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccessController.php line 155](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminAccessController.php#L155)
...
```php
\the AdminAccessController::getCurrentProfileId()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccessController.php line 200](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminAccessController.php#L200)
...
```php
mixed AdminAccessController::initContent()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccessController.php line 83](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminAccessController.php#L83)
...
```php
mixed AdminAccessController::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccessController.php line 44](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminAccessController.php#L44)
