...
* Source: [controllers/admin/AdminCurrenciesController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCurrenciesController.php#L30)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCurrenciesController.php line 32](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCurrenciesController.php#L32)
...
```php
mixed AdminCurrenciesControllerCore::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCurrenciesController.php line 96](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCurrenciesController.php#L96)
...
```php
mixed AdminCurrenciesControllerCore::initList()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCurrenciesController.php line 85](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCurrenciesController.php#L85)
...
```php
mixed AdminCurrenciesControllerCore::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCurrenciesController.php line 253](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCurrenciesController.php#L253)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCurrenciesController.php line 295](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCurrenciesController.php#L295)
