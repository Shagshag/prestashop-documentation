...
* Source: [controllers/admin/AdminStockMvtController.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStockMvtController.php#L31)
...
* Visibility: **public**
* Source: [controllers/admin/AdminStockMvtController.php line 33](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStockMvtController.php#L33)
...
* Visibility: **protected**
* Source: [controllers/admin/AdminStockMvtController.php line 355](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStockMvtController.php#L355)
...
* Visibility: **public**
* Source: [controllers/admin/AdminStockMvtController.php line 386](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStockMvtController.php#L386)
...
```php
mixed AdminStockMvtControllerCore::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStockMvtController.php line 125](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStockMvtController.php#L125)
...
```php
mixed AdminStockMvtControllerCore::initList()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStockMvtController.php line 178](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStockMvtController.php#L178)
...
```php
mixed AdminStockMvtControllerCore::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStockMvtController.php line 373](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStockMvtController.php#L373)
