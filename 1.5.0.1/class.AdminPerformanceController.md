...
* Class name: AdminPerformanceController
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminPerformanceController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminPerformanceController.php#L28)
...
```php
mixed AdminPerformanceController::initContent()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminPerformanceController.php line 463](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminPerformanceController.php#L463)
...
```php
mixed AdminPerformanceController::initFieldsetCCC()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminPerformanceController.php line 160](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminPerformanceController.php#L160)
...
```php
mixed AdminPerformanceController::initFieldsetCaching()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminPerformanceController.php line 364](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminPerformanceController.php#L364)
...
```php
mixed AdminPerformanceController::initFieldsetCiphering()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminPerformanceController.php line 325](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminPerformanceController.php#L325)
...
```php
mixed AdminPerformanceController::initFieldsetFeaturesDetachables()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminPerformanceController.php line 99](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminPerformanceController.php#L99)
...
```php
mixed AdminPerformanceController::initFieldsetMediaServer()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminPerformanceController.php line 280](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminPerformanceController.php#L280)
...
```php
mixed AdminPerformanceController::initFieldsetSmarty()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminPerformanceController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminPerformanceController.php#L30)
...
```php
mixed AdminPerformanceController::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminPerformanceController.php line 447](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminPerformanceController.php#L447)
...
```php
mixed AdminPerformanceController::initToolbar()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminPerformanceController.php line 488](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminPerformanceController.php#L488)
...
```php
mixed AdminPerformanceController::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminPerformanceController.php line 496](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminPerformanceController.php#L496)
