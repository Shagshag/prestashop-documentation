...
* Source: [controllers/admin/AdminCountriesController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCountriesController.php#L28)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCountriesController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCountriesController.php#L30)
...
* Source: [controllers/admin/AdminCountriesController.php line 430](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCountriesController.php#L430)
...
* Visibility: **private**
* Source: [controllers/admin/AdminCountriesController.php line 405](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCountriesController.php#L405)
...
```php
mixed AdminCountriesControllerCore::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCountriesController.php line 134](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCountriesController.php#L134)
...
```php
mixed AdminCountriesControllerCore::initList()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCountriesController.php line 126](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCountriesController.php#L126)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCountriesController.php line 359](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCountriesController.php#L359)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCountriesController.php line 119](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCountriesController.php#L119)
