...
* Source: [controllers/admin/AdminDeliverySlipController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminDeliverySlipController.php#L28)
...
* Visibility: **public**
* Source: [controllers/admin/AdminDeliverySlipController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminDeliverySlipController.php#L30)
...
* Visibility: **public**
* Source: [controllers/admin/AdminDeliverySlipController.php line 122](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminDeliverySlipController.php#L122)
...
```php
mixed AdminDeliverySlipControllerCore::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminDeliverySlipController.php line 60](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminDeliverySlipController.php#L60)
...
* Visibility: **public**
* Source: [controllers/admin/AdminDeliverySlipController.php line 101](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminDeliverySlipController.php#L101)
