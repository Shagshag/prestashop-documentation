Class AdminOrderMessageController
=====================
...
* Class name: AdminOrderMessageController
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminOrderMessageController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminOrderMessageController.php#L28)
...
```php
mixed AdminOrderMessageController::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminOrderMessageController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminOrderMessageController.php#L30)
