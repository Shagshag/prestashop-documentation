...
* Class name: AdminLoginController
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminLoginController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminLoginController.php#L28)
...
```php
mixed AdminLoginController::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminLoginController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminLoginController.php#L30)
...
```php
mixed AdminLoginController::checkToken()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminLoginController.php line 94](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminLoginController.php#L94)
...
```php
mixed AdminLoginController::initContent()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminLoginController.php line 51](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminLoginController.php#L51)
...
```php
mixed AdminLoginController::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminLoginController.php line 99](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminLoginController.php#L99)
...
```php
mixed AdminLoginController::processForgot()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminLoginController.php line 162](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminLoginController.php#L162)
...
```php
mixed AdminLoginController::processLogin()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminLoginController.php line 107](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminLoginController.php#L107)
...
```php
mixed AdminLoginController::setMedia()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminLoginController.php line 40](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminLoginController.php#L40)
