...
* Class name: AdminGroupsController
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminGroupsController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGroupsController.php#L28)
...
* [initCustomersList](#method-initCustomersList)
...
```php
mixed AdminGroupsController::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGroupsController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGroupsController.php#L30)
...
```php
mixed AdminGroupsController::ajaxProcessAddCategoryReduction()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGroupsController.php line 308](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGroupsController.php#L308)
...
```php
mixed AdminGroupsController::formatCategoryDiscountList($id)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminGroupsController.php line 201](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGroupsController.php#L201)
...
```php
mixed AdminGroupsController::formatModuleListAuth($id_group)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGroupsController.php line 235](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGroupsController.php#L235)
...
### <a name="method-initCustomersList"></a>initCustomersList

```php
mixed AdminGroupsController::initCustomersList($group)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminGroupsController.php line 86](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGroupsController.php#L86)
...
```php
mixed AdminGroupsController::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGroupsController.php line 119](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGroupsController.php#L119)
...
```php
mixed AdminGroupsController::initView()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGroupsController.php line 71](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGroupsController.php#L71)
...
```php
mixed AdminGroupsController::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGroupsController.php line 278](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGroupsController.php#L278)
...
```php
mixed AdminGroupsController::setMedia()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGroupsController.php line 64](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGroupsController.php#L64)
...
```php
mixed AdminGroupsController::updateCategoryReduction()
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminGroupsController.php line 353](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGroupsController.php#L353)
...
```php
mixed AdminGroupsController::updateRestrictions()
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminGroupsController.php line 337](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGroupsController.php#L337)
...
```php
mixed AdminGroupsController::validateDiscount($reduction)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminGroupsController.php line 300](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGroupsController.php#L300)
