...
* Source: [controllers/admin/AdminCartRulesController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartRulesController.php#L28)
...
* [getProductRulesDisplay](#method-getProductRulesDisplay)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartRulesController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartRulesController.php#L30)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartRulesController.php line 88](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartRulesController.php#L88)
...
```php
mixed AdminCartRulesControllerCore::afterUpdate($currentObject)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartRulesController.php line 75](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartRulesController.php#L75)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartRulesController.php line 217](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartRulesController.php#L217)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartRulesController.php line 345](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartRulesController.php#L345)
...
```php
mixed AdminCartRulesControllerCore::getProductRuleDisplay($product_rule_id, $product_rule_type, $product_rule_quantity, $selected)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartRulesController.php line 155](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartRulesController.php#L155)


#### Arguments
* $product_rule_id **mixed**
* $product_rule_type **mixed**
* $product_rule_quantity **mixed**
* $selected **mixed**



### <a name="method-getProductRulesDisplay"></a>getProductRulesDisplay

```php
mixed AdminCartRulesControllerCore::getProductRulesDisplay($cartRule)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartRulesController.php line 247](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartRulesController.php#L247)
...
```php
mixed AdminCartRulesControllerCore::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartRulesController.php line 271](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartRulesController.php#L271)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartRulesController.php line 52](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartRulesController.php#L52)
