...
* Source: [controllers/admin/AdminTagsController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminTagsController.php#L28)
...
* Visibility: **public**
* Source: [controllers/admin/AdminTagsController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminTagsController.php#L30)
...
```php
mixed AdminTagsControllerCore::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminTagsController.php line 90](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminTagsController.php#L90)
...
```php
mixed AdminTagsControllerCore::initList()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminTagsController.php line 61](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminTagsController.php#L61)
...
* Visibility: **public**
* Source: [controllers/admin/AdminTagsController.php line 82](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminTagsController.php#L82)
