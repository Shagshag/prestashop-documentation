...
* Source: [classes/stock/StockManagerModule.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/stock/StockManagerModule.php#L31)
...
* Visibility: **public**
* Source: [classes/stock/StockManagerModule.php line 33](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/stock/StockManagerModule.php#L33).
...
```php
mixed StockManagerModule::hookStockManager()
```
...
* Visibility: **public**
* Source: [classes/stock/StockManagerModule.php line 40](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/stock/StockManagerModule.php#L40)
...
```php
mixed StockManagerModule::install()
```
...
* Visibility: **public**
* Source: [classes/stock/StockManagerModule.php line 35](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/stock/StockManagerModule.php#L35)
