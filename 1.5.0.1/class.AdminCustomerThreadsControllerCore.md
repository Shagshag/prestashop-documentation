...
* Source: [controllers/admin/AdminCustomerThreadsController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCustomerThreadsController.php#L28)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCustomerThreadsController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCustomerThreadsController.php#L30)
...
* Visibility: **private**
* Source: [controllers/admin/AdminCustomerThreadsController.php line 619](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCustomerThreadsController.php#L619)
...
```php
mixed AdminCustomerThreadsControllerCore::displayListHeader($token)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCustomerThreadsController.php line 227](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCustomerThreadsController.php#L227)
...
### <a name="method-displayMsg"></a>displayMsg

```php
mixed AdminCustomerThreadsControllerCore::displayMsg($message, $email, $id_employee)
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminCustomerThreadsController.php line 311](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCustomerThreadsController.php#L311)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCustomerThreadsController.php line 218](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCustomerThreadsController.php#L218)
...
```php
mixed AdminCustomerThreadsControllerCore::initOptions()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCustomerThreadsController.php line 630](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCustomerThreadsController.php#L630)
...
```php
mixed AdminCustomerThreadsControllerCore::initView()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCustomerThreadsController.php line 421](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCustomerThreadsController.php#L421)
...
* Visibility: **private**
* Source: [controllers/admin/AdminCustomerThreadsController.php line 290](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCustomerThreadsController.php#L290)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCustomerThreadsController.php line 110](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCustomerThreadsController.php#L110)
