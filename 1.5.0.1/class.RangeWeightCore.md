...
* Source: [classes/RangeWeight.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/RangeWeight.php#L28)
...
* Visibility: **public**
* Source: [classes/RangeWeight.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/RangeWeight.php#L31).
...
* Visibility: **public**
* Source: [classes/RangeWeight.php line 32](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/RangeWeight.php#L32).


### <a name="property-$fieldsRequired"></a>$fieldsRequired

```php
protected mixed $fieldsRequired = array('id_carrier', 'delimiter1', 'delimiter2')
```
...
* Source: [classes/RangeWeight.php line 34](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/RangeWeight.php#L34).


### <a name="property-$fieldsValidate"></a>$fieldsValidate

```php
protected mixed $fieldsValidate = array('id_carrier' => 'isInt', 'delimiter1' => 'isUnsignedFloat', 'delimiter2' => 'isUnsignedFloat')
```
...
* Visibility: **protected**
* Source: [classes/RangeWeight.php line 35](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/RangeWeight.php#L35).
...
* Visibility: **public**
* Source: [classes/RangeWeight.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/RangeWeight.php#L30).


### <a name="property-$identifier"></a>$identifier

```php
protected mixed $identifier = 'id_range_weight'
```
...
* Visibility: **protected**
* Source: [classes/RangeWeight.php line 38](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/RangeWeight.php#L38).


### <a name="property-$table"></a>$table

```php
protected mixed $table = 'range_weight'
```
...
* Visibility: **protected**
* Source: [classes/RangeWeight.php line 37](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/RangeWeight.php#L37).
...
* Visibility: **protected**
* Source: [classes/RangeWeight.php line 40](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/RangeWeight.php#L40).
...
```php
mixed RangeWeightCore::getFields()
```
...
* Visibility: **public**
* Source: [classes/RangeWeight.php line 48](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/RangeWeight.php#L48)
...
* Visibility: **public**
* This method is **static**.
* Source: [classes/RangeWeight.php line 62](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/RangeWeight.php#L62)
