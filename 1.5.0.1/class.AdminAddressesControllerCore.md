...
* Source: [controllers/admin/AdminAddressesController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminAddressesController.php#L28)
...
* Visibility: **private**
* Source: [controllers/admin/AdminAddressesController.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminAddressesController.php#L31).
...
* Visibility: **public**
* Source: [controllers/admin/AdminAddressesController.php line 33](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminAddressesController.php#L33)
...
```php
mixed AdminAddressesControllerCore::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAddressesController.php line 75](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminAddressesController.php#L75)
...
```php
mixed AdminAddressesControllerCore::initList()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAddressesController.php line 61](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminAddressesController.php#L61)
...
```php
mixed AdminAddressesControllerCore::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAddressesController.php line 279](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminAddressesController.php#L279)
...
* Visibility: **protected**
* Source: [controllers/admin/AdminAddressesController.php line 364](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminAddressesController.php#L364)
