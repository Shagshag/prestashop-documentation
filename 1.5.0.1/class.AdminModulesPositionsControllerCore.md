...
* Source: [controllers/admin/AdminModulesPositionsController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminModulesPositionsController.php#L28)
...
### <a name="property-$displayKey"></a>$displayKey

```php
private mixed $displayKey
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminModulesPositionsController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminModulesPositionsController.php#L30).
...
```php
mixed AdminModulesPositionsControllerCore::displayModuleExceptionList($fileList, $shopID)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminModulesPositionsController.php line 368](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminModulesPositionsController.php#L368)
...
* Visibility: **public**
* Source: [controllers/admin/AdminModulesPositionsController.php line 217](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminModulesPositionsController.php#L217)
...
```php
mixed AdminModulesPositionsControllerCore::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminModulesPositionsController.php line 290](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminModulesPositionsController.php#L290)
...
* Visibility: **public**
* Source: [controllers/admin/AdminModulesPositionsController.php line 232](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminModulesPositionsController.php#L232)
...
* Visibility: **public**
* Source: [controllers/admin/AdminModulesPositionsController.php line 32](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminModulesPositionsController.php#L32)
