...
* Class name: AdminImportController
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminImportController.php line 41](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L41)
...
* Visibility: **public**
* Source: [controllers/admin/AdminImportController.php line 47](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L47).
...
* Source: [controllers/admin/AdminImportController.php line 43](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L43).
...
* Visibility: **public**
* This property is **static**.
* Source: [controllers/admin/AdminImportController.php line 51](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L51).
...
* Visibility: **public**
* Source: [controllers/admin/AdminImportController.php line 45](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L45).
...
* Visibility: **public**
* This property is **static**.
* Source: [controllers/admin/AdminImportController.php line 49](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L49).
...
* Visibility: **public**
* This property is **static**.
* Source: [controllers/admin/AdminImportController.php line 53](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L53).
...
```php
mixed AdminImportController::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImportController.php line 77](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L77)
...
```php
mixed AdminImportController::addProductWarning($product_name, $product_id, $message)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminImportController.php line 1841](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L1841)
...
```php
mixed AdminImportController::addressImport()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImportController.php line 1379](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L1379)
...
```php
mixed AdminImportController::arrayWalk($array, $funcname, $user_data)
```
...
* Source: [controllers/admin/AdminImportController.php line 660](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L660)
...
```php
mixed AdminImportController::attributeImport()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImportController.php line 1172](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L1172)
...
```php
mixed AdminImportController::categoryImport()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImportController.php line 716](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L716)
...
```php
mixed AdminImportController::closeCsvFile($handle)
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminImportController.php line 1684](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L1684)
...
```php
void AdminImportController::copyImg(integer $id_entity, integer $id_image, string $url, $entity)
```
...
* Visibility: **private**
* This method is **static**.
* Source: [controllers/admin/AdminImportController.php line 681](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L681)
...
```php
mixed AdminImportController::createMultiLangField($field)
```
...
* Visibility: **private**
* This method is **static**.
* Source: [controllers/admin/AdminImportController.php line 554](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L554)
...
```php
mixed AdminImportController::customerImport()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImportController.php line 1329](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L1329)
...
```php
mixed AdminImportController::fillInfo($infos, $key, $entity)
```
...
* Visibility: **private**
* This method is **static**.
* Source: [controllers/admin/AdminImportController.php line 645](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L645)
...
```php
mixed AdminImportController::generateContentTable($current_table, $nb_column, $handle, $glue)
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminImportController.php line 451](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L451)
...
```php
mixed AdminImportController::getAvailableFields($in_array)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImportController.php line 588](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L588)
...
```php
mixed AdminImportController::getBoolean($field)
```
...
* Visibility: **private**
* This method is **static**.
* Source: [controllers/admin/AdminImportController.php line 521](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L521)
...
```php
mixed AdminImportController::getMaskedRow($row)
```
...
* Visibility: **public**
* This method is **static**.
* Source: [controllers/admin/AdminImportController.php line 622](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L622)
...
```php
mixed AdminImportController::getNbrColumn($handle, $glue)
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminImportController.php line 1652](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L1652)
...
```php
mixed AdminImportController::getPrice($field)
```
...
* Visibility: **private**
* This method is **static**.
* Source: [controllers/admin/AdminImportController.php line 526](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L526)
...
```php
mixed AdminImportController::getTypeValuesOptions($nb_c)
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminImportController.php line 563](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L563)
...
```php
mixed AdminImportController::init()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImportController.php line 491](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L491)
...
```php
mixed AdminImportController::initContent()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImportController.php line 498](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L498)
...
```php
mixed AdminImportController::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImportController.php line 346](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L346)
...
```php
mixed AdminImportController::initToolbar()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImportController.php line 427](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L427)
...
```php
mixed AdminImportController::initView()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImportController.php line 386](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L386)
...
```php
mixed AdminImportController::manufacturerImport()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImportController.php line 1525](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L1525)
...
```php
mixed AdminImportController::openCsvFile()
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminImportController.php line 1670](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L1670)
...
```php
mixed AdminImportController::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImportController.php line 1749](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L1749)
...
```php
mixed AdminImportController::productImport()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImportController.php line 830](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L830)
...
```php
mixed AdminImportController::receiveTab()
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminImportController.php line 614](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L614)
...
```php
mixed AdminImportController::rewindBomAware($handle)
```
...
* Visibility: **private**
* This method is **static**.
* Source: [controllers/admin/AdminImportController.php line 513](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L513)
...
```php
mixed AdminImportController::setDefaultValues($info)
```
...
* Visibility: **private**
* This method is **static**.
* Source: [controllers/admin/AdminImportController.php line 630](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L630)
...
```php
mixed AdminImportController::setEntityDefaultValues($entity)
```
...
* Visibility: **private**
* This method is **static**.
* Source: [controllers/admin/AdminImportController.php line 637](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L637)
...
```php
mixed AdminImportController::setLocale()
```
...
* Visibility: **public**
* This method is **static**.
* Source: [controllers/admin/AdminImportController.php line 1834](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L1834)
...
```php
mixed AdminImportController::split($field)
```
...
* Visibility: **private**
* This method is **static**.
* Source: [controllers/admin/AdminImportController.php line 533](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L533)
...
```php
mixed AdminImportController::supplierImport()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImportController.php line 1583](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L1583)
...
```php
mixed AdminImportController::truncateTables($case)
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminImportController.php line 1689](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L1689)
...
```php
mixed AdminImportController::usortFiles($a, $b)
```
...
* Visibility: **private**
* This method is **static**.
* Source: [controllers/admin/AdminImportController.php line 1659](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L1659)
...
```php
mixed AdminImportController::utf8EncodeArray($array)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminImportController.php line 1641](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminImportController.php#L1641)
