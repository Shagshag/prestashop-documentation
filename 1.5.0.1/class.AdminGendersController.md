...
* Class name: AdminGendersController
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminGendersController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGendersController.php#L28)
...
```php
mixed AdminGendersController::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGendersController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGendersController.php#L30)
...
```php
mixed AdminGendersController::displayGenderType($value, $tr)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGendersController.php line 172](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGendersController.php#L172)
...
```php
mixed AdminGendersController::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGendersController.php line 92](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGendersController.php#L92)
...
```php
mixed AdminGendersController::postImage($id)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminGendersController.php line 177](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGendersController.php#L177)
