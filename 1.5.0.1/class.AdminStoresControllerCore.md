...
* Source: [controllers/admin/AdminStoresController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStoresController.php#L28)
...
* Visibility: **public**
* Source: [controllers/admin/AdminStoresController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStoresController.php#L30)
...
```php
mixed AdminStoresControllerCore::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStoresController.php line 133](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStoresController.php#L133)
...
```php
mixed AdminStoresControllerCore::initList()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStoresController.php line 115](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStoresController.php#L115)
...
* Visibility: **protected**
* Source: [controllers/admin/AdminStoresController.php line 369](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStoresController.php#L369)
...
* Visibility: **public**
* Source: [controllers/admin/AdminStoresController.php line 298](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminStoresController.php#L298)
