...
* Source: [controllers/admin/AdminGeolocationController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGeolocationController.php#L28)
...
* Visibility: **public**
* Source: [controllers/admin/AdminGeolocationController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGeolocationController.php#L30)
...
* Visibility: **public**
* Source: [controllers/admin/AdminGeolocationController.php line 139](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGeolocationController.php#L139)
...
```php
mixed AdminGeolocationControllerCore::initOptions()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGeolocationController.php line 132](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGeolocationController.php#L132)
...
* Visibility: **private**
* Source: [controllers/admin/AdminGeolocationController.php line 150](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGeolocationController.php#L150)
...
* Visibility: **public**
* Source: [controllers/admin/AdminGeolocationController.php line 88](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminGeolocationController.php#L88)
