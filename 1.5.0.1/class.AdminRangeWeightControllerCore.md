...
* Source: [controllers/admin/AdminRangeWeightController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminRangeWeightController.php#L28)
...
* Visibility: **public**
* Source: [controllers/admin/AdminRangeWeightController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminRangeWeightController.php#L30)
...
* Visibility: **public**
* Source: [controllers/admin/AdminRangeWeightController.php line 107](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminRangeWeightController.php#L107)
...
```php
mixed AdminRangeWeightControllerCore::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminRangeWeightController.php line 53](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminRangeWeightController.php#L53)
...
* Visibility: **public**
* Source: [controllers/admin/AdminRangeWeightController.php line 116](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminRangeWeightController.php#L116)
