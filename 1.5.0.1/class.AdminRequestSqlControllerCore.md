...
* Source: [controllers/admin/AdminRequestSqlController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminRequestSqlController.php#L28)
...
* Visibility: **public**
* Source: [controllers/admin/AdminRequestSqlController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminRequestSqlController.php#L30)
...
* Visibility: **public**
* Source: [controllers/admin/AdminRequestSqlController.php line 139](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminRequestSqlController.php#L139)
...
### <a name="method-bulkexport"></a>bulkexport

```php
mixed AdminRequestSqlControllerCore::bulkexport($boxes)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminRequestSqlController.php line 152](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminRequestSqlController.php#L152)
...
* Visibility: **public**
* Source: [controllers/admin/AdminRequestSqlController.php line 214](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminRequestSqlController.php#L214)
...
```php
mixed AdminRequestSqlControllerCore::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminRequestSqlController.php line 79](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminRequestSqlController.php#L79)
...
```php
mixed AdminRequestSqlControllerCore::initList()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminRequestSqlController.php line 49](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminRequestSqlController.php#L49)
...
```php
mixed AdminRequestSqlControllerCore::initView()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminRequestSqlController.php line 111](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminRequestSqlController.php#L111)
...
* Visibility: **public**
* Source: [controllers/admin/AdminRequestSqlController.php line 198](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminRequestSqlController.php#L198)
