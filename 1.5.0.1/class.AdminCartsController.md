...
* Class name: AdminCartsController
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminCartsController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L28)
...
* [ajaxProcessUpdateCarrier](#method-ajaxProcessUpdateCarrier)
...
* [getAvailableCarriers](#method-getAvailableCarriers)
...
```php
mixed AdminCartsController::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartsController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L30)
...
```php
mixed AdminCartsController::ajaxPreProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartsController.php line 184](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L184)
...
```php
mixed AdminCartsController::ajaxProcessAddVoucher()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartsController.php line 353](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L353)
...
```php
mixed AdminCartsController::ajaxProcessDeleteProduct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartsController.php line 224](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L224)
...
```php
mixed AdminCartsController::ajaxProcessDeleteVoucher()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartsController.php line 344](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L344)
...
```php
mixed AdminCartsController::ajaxProcessDuplicateOrder()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartsController.php line 323](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L323)
...
```php
mixed AdminCartsController::ajaxProcessUpdateAddresses()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartsController.php line 371](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L371)




### <a name="method-ajaxProcessUpdateCarrier"></a>ajaxProcessUpdateCarrier

```php
mixed AdminCartsController::ajaxProcessUpdateCarrier()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartsController.php line 282](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L282)
...
```php
mixed AdminCartsController::ajaxProcessUpdateCurrency()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartsController.php line 297](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L297)
...
```php
mixed AdminCartsController::ajaxProcessUpdateLang()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartsController.php line 310](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L310)
...
```php
mixed AdminCartsController::ajaxProcessUpdateProductPrice()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartsController.php line 491](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L491)
...
```php
mixed AdminCartsController::ajaxProcessUpdateQty()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartsController.php line 239](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L239)
...
```php
mixed AdminCartsController::ajaxReturnVars()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartsController.php line 470](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L470)
...
```php
mixed AdminCartsController::displayAjaxGetSummary()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartsController.php line 486](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L486)
...
```php
mixed AdminCartsController::displayAjaxSearchCarts()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartsController.php line 440](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L440)
...
### <a name="method-getAvailableCarriers"></a>getAvailableCarriers

```php
mixed AdminCartsController::getAvailableCarriers()
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminCartsController.php line 434](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L434)
...
```php
mixed AdminCartsController::getCartSummary()
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminCartsController.php line 390](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L390)
...
```php
mixed AdminCartsController::getOrderTotalUsingTaxCalculationMethod($id_cart)
```
...
* Visibility: **public**
* This method is **static**.
* Source: [controllers/admin/AdminCartsController.php line 496](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L496)
...
```php
mixed AdminCartsController::initView()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCartsController.php line 102](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L102)
...
```php
mixed AdminCartsController::replaceZeroByShopName($echo, $tr)
```
...
* Visibility: **public**
* This method is **static**.
* Source: [controllers/admin/AdminCartsController.php line 504](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminCartsController.php#L504)
