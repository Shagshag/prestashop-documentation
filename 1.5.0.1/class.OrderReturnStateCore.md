...
* Source: [classes/order/OrderReturnState.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderReturnState.php#L28)
...
* Visibility: **public**
* Source: [classes/order/OrderReturnState.php line 34](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderReturnState.php#L34).
...
* Source: [classes/order/OrderReturnState.php line 37](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderReturnState.php#L37).
...
* Visibility: **protected**
* Source: [classes/order/OrderReturnState.php line 38](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderReturnState.php#L38).


### <a name="property-$fieldsValidate"></a>$fieldsValidate

```php
protected mixed $fieldsValidate = array('color' => 'isColor')
```
...
* Visibility: **protected**
* Source: [classes/order/OrderReturnState.php line 36](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderReturnState.php#L36).
...
* Visibility: **protected**
* Source: [classes/order/OrderReturnState.php line 39](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderReturnState.php#L39).


### <a name="property-$identifier"></a>$identifier

```php
protected mixed $identifier = 'id_order_return_state'
```
...
* Visibility: **protected**
* Source: [classes/order/OrderReturnState.php line 42](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderReturnState.php#L42).
...
* Visibility: **public**
* Source: [classes/order/OrderReturnState.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderReturnState.php#L31).


### <a name="property-$table"></a>$table

```php
protected mixed $table = 'order_return_state'
```
...
* Visibility: **protected**
* Source: [classes/order/OrderReturnState.php line 41](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderReturnState.php#L41).
...
```php
mixed OrderReturnStateCore::getFields()
```
...
* Visibility: **public**
* Source: [classes/order/OrderReturnState.php line 44](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderReturnState.php#L44)
...
* Visibility: **public**
* This method is **static**.
* Source: [classes/order/OrderReturnState.php line 68](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderReturnState.php#L68)
...
```php
array OrderReturnStateCore::getTranslationsFieldsChild()
```
...
* Visibility: **public**
* Source: [classes/order/OrderReturnState.php line 56](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/order/OrderReturnState.php#L56)
