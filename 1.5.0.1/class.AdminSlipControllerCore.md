...
* Source: [controllers/admin/AdminSlipController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminSlipController.php#L28)
...
* Visibility: **public**
* Source: [controllers/admin/AdminSlipController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminSlipController.php#L30)
...
* Visibility: **public**
* Source: [controllers/admin/AdminSlipController.php line 132](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminSlipController.php#L132)
...
```php
mixed AdminSlipControllerCore::initForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminSlipController.php line 68](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminSlipController.php#L68)
...
```php
mixed AdminSlipControllerCore::initList()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminSlipController.php line 59](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminSlipController.php#L59)
...
* Visibility: **public**
* Source: [controllers/admin/AdminSlipController.php line 144](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminSlipController.php#L144)
...
* Visibility: **public**
* Source: [controllers/admin/AdminSlipController.php line 111](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/admin/AdminSlipController.php#L111)
