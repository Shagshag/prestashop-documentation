...
* Source: [controllers/front/ModuleController.php line 34](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/front/ModuleController.php#L34)
...
```php
mixed ModuleControllerCore::initContent()
```
...
* Visibility: **public**
* Source: [controllers/front/ModuleController.php line 40](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/controllers/front/ModuleController.php#L40)
