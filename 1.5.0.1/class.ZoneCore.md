...
* Source: [classes/Zone.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/Zone.php#L28)
...
* Visibility: **public**
* Source: [classes/Zone.php line 34](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/Zone.php#L34).


### <a name="property-$eu_zone"></a>$eu_zone

```php
public mixed $eu_zone = false
```
...
* Visibility: **public**
* Source: [classes/Zone.php line 35](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/Zone.php#L35).
...
* Source: [classes/Zone.php line 37](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/Zone.php#L37).
...
* Visibility: **protected**
* Source: [classes/Zone.php line 38](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/Zone.php#L38).


### <a name="property-$fieldsValidate"></a>$fieldsValidate

```php
protected mixed $fieldsValidate = array('name' => 'isGenericName', 'active' => 'isBool')
```
...
* Visibility: **protected**
* Source: [classes/Zone.php line 39](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/Zone.php#L39).


### <a name="property-$identifier"></a>$identifier

```php
protected mixed $identifier = 'id_zone'
```
...
* Visibility: **protected**
* Source: [classes/Zone.php line 42](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/Zone.php#L42).
...
* Visibility: **public**
* Source: [classes/Zone.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/Zone.php#L31).


### <a name="property-$table"></a>$table

```php
protected mixed $table = 'zone'
```
...
* Visibility: **protected**
* Source: [classes/Zone.php line 41](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/Zone.php#L41).
...
* Visibility: **protected**
* Source: [classes/Zone.php line 44](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/Zone.php#L44).
...
* Visibility: **public**
* Source: [classes/Zone.php line 88](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/Zone.php#L88)
...
* Visibility: **public**
* Source: [classes/Zone.php line 46](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/Zone.php#L46)
...
```php
integer ZoneCore::getIdByName($name)
```
...
* Visibility: **public**
* This method is **static**.
* Source: [classes/Zone.php line 75](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/Zone.php#L75)
...
```php
array ZoneCore::getZones($active)
```
...
* Visibility: **public**
* This method is **static**.
* Source: [classes/Zone.php line 61](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.1/classes/Zone.php#L61)
