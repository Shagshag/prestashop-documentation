...
* Source: [classes/Logger.php line 27](https://github.com/PrestaShop/PrestaShop/blob/1.5.3.1/classes/Logger.php#L27)
...
* Visibility: **public**
* Source: [classes/Logger.php line 48](https://github.com/PrestaShop/PrestaShop/blob/1.5.3.1/classes/Logger.php#L48).
...
* Visibility: **public**
* Source: [classes/Logger.php line 51](https://github.com/PrestaShop/PrestaShop/blob/1.5.3.1/classes/Logger.php#L51).


### <a name="property-$definition"></a>$definition

```php
public mixed $definition = array('table' => 'log', 'primary' => 'id_log', 'fields' => array('severity' => array('type' => self::TYPE_INT, 'validate' => 'isInt', 'required' => true), 'error_code' => array('type' => self::TYPE_INT, 'validate' => 'isUnsignedInt'), 'message' => array('type' => self::TYPE_STRING, 'validate' => 'isMessage', 'required' => true), 'object_id' => array('type' => self::TYPE_INT, 'validate' => 'isUnsignedInt'), 'object_type' => array('type' => self::TYPE_STRING, 'validate' => 'isName'), 'date_add' => array('type' => self::TYPE_DATE, 'validate' => 'isDate'), 'date_upd' => array('type' => self::TYPE_DATE, 'validate' => 'isDate')))
```
...
* Source: [classes/Logger.php line 56](https://github.com/PrestaShop/PrestaShop/blob/1.5.3.1/classes/Logger.php#L56).
...
* Visibility: **public**
* Source: [classes/Logger.php line 36](https://github.com/PrestaShop/PrestaShop/blob/1.5.3.1/classes/Logger.php#L36).
...
* Visibility: **public**
* Source: [classes/Logger.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.3.1/classes/Logger.php#L30).
...
* This property is **static**.
* Source: [classes/Logger.php line 70](https://github.com/PrestaShop/PrestaShop/blob/1.5.3.1/classes/Logger.php#L70).
...
* Visibility: **public**
* Source: [classes/Logger.php line 39](https://github.com/PrestaShop/PrestaShop/blob/1.5.3.1/classes/Logger.php#L39).
...
* Visibility: **public**
* Source: [classes/Logger.php line 45](https://github.com/PrestaShop/PrestaShop/blob/1.5.3.1/classes/Logger.php#L45).
...
* Visibility: **public**
* Source: [classes/Logger.php line 42](https://github.com/PrestaShop/PrestaShop/blob/1.5.3.1/classes/Logger.php#L42).
...
* Visibility: **public**
* Source: [classes/Logger.php line 33](https://github.com/PrestaShop/PrestaShop/blob/1.5.3.1/classes/Logger.php#L33).
...
* Visibility: **protected**
* Source: [classes/Logger.php line 147](https://github.com/PrestaShop/PrestaShop/blob/1.5.3.1/classes/Logger.php#L147)
...
```php
boolean LoggerCore::addLog(string $message, integer $severity, integer $error_code, string $object_type, integer $object_id, boolean $allow_duplicate)
```
...
* Source: [classes/Logger.php line 101](https://github.com/PrestaShop/PrestaShop/blob/1.5.3.1/classes/Logger.php#L101)
...
* Visibility: **public**
* Source: [classes/Logger.php line 134](https://github.com/PrestaShop/PrestaShop/blob/1.5.3.1/classes/Logger.php#L134)
...
* Visibility: **public**
* This method is **static**.
* Source: [classes/Logger.php line 78](https://github.com/PrestaShop/PrestaShop/blob/1.5.3.1/classes/Logger.php#L78)
