Class AdminCatalogControllerCore
=====================
...
* Class name: AdminCatalogControllerCore
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminCatalogController.php line 29](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/controllers/admin/AdminCatalogController.php#L29)
...
* Source: [controllers/admin/AdminCatalogController.php line 44](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/controllers/admin/AdminCatalogController.php#L44).
...
* Visibility: **private**
* Source: [controllers/admin/AdminCatalogController.php line 38](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/controllers/admin/AdminCatalogController.php#L38).
...
* Visibility: **private**
* Source: [controllers/admin/AdminCatalogController.php line 41](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/controllers/admin/AdminCatalogController.php#L41).
...
```php
mixed AdminCatalogControllerCore::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCatalogController.php line 46](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/controllers/admin/AdminCatalogController.php#L46)
...
```php
mixed AdminCatalogControllerCore::ajaxProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCatalogController.php line 110](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/controllers/admin/AdminCatalogController.php#L110)
...
```php
object AdminCatalogControllerCore::getCurrentCategory()
```
...
* Visibility: **public**
* This method is **static**.
* Source: [controllers/admin/AdminCatalogController.php line 84](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/controllers/admin/AdminCatalogController.php#L84)
...
```php
mixed AdminCatalogControllerCore::initContent()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCatalogController.php line 121](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/controllers/admin/AdminCatalogController.php#L121)
...
```php
mixed AdminCatalogControllerCore::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCatalogController.php line 97](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/controllers/admin/AdminCatalogController.php#L97)
...
```php
mixed AdminCatalogControllerCore::viewAccess($disable)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCatalogController.php line 89](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/controllers/admin/AdminCatalogController.php#L89)
