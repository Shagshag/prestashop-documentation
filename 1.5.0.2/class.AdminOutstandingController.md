...
* Class name: AdminOutstandingController
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminOutstandingController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/controllers/admin/AdminOutstandingController.php#L28)
...
```php
mixed AdminOutstandingController::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminOutstandingController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/controllers/admin/AdminOutstandingController.php#L30)
...
```php
boolean AdminOutstandingController::initToolbar()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminOutstandingController.php line 121](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/controllers/admin/AdminOutstandingController.php#L121)
...
```php
mixed AdminOutstandingController::printOutstandingCalculation($id_invoice, $tr)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminOutstandingController.php line 141](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/controllers/admin/AdminOutstandingController.php#L141)
...
```php
string AdminOutstandingController::printPDFIcons($id_invoice, $tr)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminOutstandingController.php line 132](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/controllers/admin/AdminOutstandingController.php#L132)
...
```php
mixed AdminOutstandingController::renderView()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminOutstandingController.php line 160](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/controllers/admin/AdminOutstandingController.php#L160)
