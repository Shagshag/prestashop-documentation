...
* Source: [classes/order/OrderCarrier.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/classes/order/OrderCarrier.php#L28)
...
* Visibility: **public**
* Source: [classes/order/OrderCarrier.php line 55](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/classes/order/OrderCarrier.php#L55).


### <a name="property-$definition"></a>$definition

```php
public mixed $definition = array('table' => 'order_carrier', 'primary' => 'id_order_carrier', 'fields' => array('id_order' => array('type' => self::TYPE_INT, 'validate' => 'isUnsignedId', 'required' => true), 'id_carrier' => array('type' => self::TYPE_INT, 'validate' => 'isUnsignedId', 'required' => true), 'id_order_invoice' => array('type' => self::TYPE_INT, 'validate' => 'isUnsignedId'), 'weight' => array('type' => self::TYPE_FLOAT, 'validate' => 'isFloat'), 'shipping_cost_tax_excl' => array('type' => self::TYPE_FLOAT, 'validate' => 'isFloat'), 'shipping_cost_tax_incl' => array('type' => self::TYPE_FLOAT, 'validate' => 'isFloat'), 'tracking_number' => array('type' => self::TYPE_STRING, 'validate' => 'isAnything'), 'date_add' => array('type' => self::TYPE_DATE, 'validate' => 'isDate')))
```
...
* Source: [classes/order/OrderCarrier.php line 60](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/classes/order/OrderCarrier.php#L60).
...
* Visibility: **public**
* Source: [classes/order/OrderCarrier.php line 37](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/classes/order/OrderCarrier.php#L37).
...
* Visibility: **public**
* Source: [classes/order/OrderCarrier.php line 34](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/classes/order/OrderCarrier.php#L34).
...
* Visibility: **public**
* Source: [classes/order/OrderCarrier.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/classes/order/OrderCarrier.php#L31).
...
* Visibility: **public**
* Source: [classes/order/OrderCarrier.php line 40](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/classes/order/OrderCarrier.php#L40).
...
* Visibility: **public**
* Source: [classes/order/OrderCarrier.php line 46](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/classes/order/OrderCarrier.php#L46).
...
* Visibility: **public**
* Source: [classes/order/OrderCarrier.php line 49](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/classes/order/OrderCarrier.php#L49).
...
* Visibility: **public**
* Source: [classes/order/OrderCarrier.php line 52](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/classes/order/OrderCarrier.php#L52).
...
* Source: [classes/order/OrderCarrier.php line 75](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/classes/order/OrderCarrier.php#L75).
...
* Visibility: **public**
* Source: [classes/order/OrderCarrier.php line 43](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.2/classes/order/OrderCarrier.php#L43).
