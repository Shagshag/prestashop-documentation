...
* Source: [controllers/admin/AdminCmsContentController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminCmsContentController.php#L28)
...
* [$adminCMS](#property-$adminCMS)
* [$adminCMSCategories](#property-$adminCMSCategories)
...
* Source: [controllers/admin/AdminCmsContentController.php line 37](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminCmsContentController.php#L37).


### <a name="property-$adminCMS"></a>$adminCMS

```php
private object $adminCMS
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminCmsContentController.php line 34](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminCmsContentController.php#L34).


### <a name="property-$adminCMSCategories"></a>$adminCMSCategories

```php
private object $adminCMSCategories
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminCmsContentController.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminCmsContentController.php#L31).
...
* Visibility: **public**
* Source: [controllers/admin/AdminCmsContentController.php line 39](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminCmsContentController.php#L39)
...
* Visibility: **public**
* This method is **static**.
* Source: [controllers/admin/AdminCmsContentController.php line 59](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminCmsContentController.php#L59)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCmsContentController.php line 72](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminCmsContentController.php#L72)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCmsContentController.php line 109](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminCmsContentController.php#L109)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCmsContentController.php line 64](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminCmsContentController.php#L64)
