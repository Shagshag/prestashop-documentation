...
* Class name: AdminDbControllerCore
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminDbController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminDbController.php#L28)
...
* [getTablesStatus](#method-getTablesStatus)
...
```php
mixed AdminDbControllerCore::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminDbController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminDbController.php#L30)
...
### <a name="method-getEngines"></a>getEngines

```php
mixed AdminDbControllerCore::getEngines()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminDbController.php line 259](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminDbController.php#L259)
...
### <a name="method-getTablesStatus"></a>getTablesStatus

```php
mixed AdminDbControllerCore::getTablesStatus()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminDbController.php line 269](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminDbController.php#L269)
...
```php
mixed AdminDbControllerCore::initContent()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminDbController.php line 102](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminDbController.php#L102)
...
```php
mixed AdminDbControllerCore::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminDbController.php line 185](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminDbController.php#L185)
...
```php
mixed AdminDbControllerCore::renderForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminDbController.php line 116](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminDbController.php#L116)
