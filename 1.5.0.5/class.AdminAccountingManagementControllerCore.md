Class AdminAccountingManagementControllerCore
=====================
...
* Class name: AdminAccountingManagementControllerCore
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminAccountingManagementController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingManagementController.php#L28)
...
* [updateAccountNumber](#method-updateAccountNumber)
...
```php
mixed AdminAccountingManagementControllerCore::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingManagementController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingManagementController.php#L30)
...
```php
mixed AdminAccountingManagementControllerCore::initContent()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingManagementController.php line 37](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingManagementController.php#L37)
...
```php
mixed AdminAccountingManagementControllerCore::initToolbar()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingManagementController.php line 94](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingManagementController.php#L94)
...
```php
mixed AdminAccountingManagementControllerCore::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingManagementController.php line 83](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingManagementController.php#L83)
...
### <a name="method-updateAccountNumber"></a>updateAccountNumber

```php
mixed AdminAccountingManagementControllerCore::updateAccountNumber()
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminAccountingManagementController.php line 106](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingManagementController.php#L106)
