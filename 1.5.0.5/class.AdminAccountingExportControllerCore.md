Class AdminAccountingExportControllerCore
=====================
...
* Class name: AdminAccountingExportControllerCore
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminAccountingExportController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L28)
...
* [$clientPrefix](#property-$clientPrefix)
* [$date](#property-$date)
* [$defaultType](#property-$defaultType)
* [$downloadDir](#property-$downloadDir)
* [$downloadFile](#property-$downloadFile)
* [$exportSelected](#property-$exportSelected)
* [$exportTypeList](#property-$exportTypeList)
* [$exportedFilePath](#property-$exportedFilePath)
* [$fd](#property-$fd)
* [$pathTheme](#property-$pathTheme)
* [$prevent](#property-$prevent)
...
* [buildGlobalExportlist](#method-buildGlobalExportlist)
* [checkAccess](#method-checkAccess)
* [checkRights](#method-checkRights)
* [checkToken](#method-checkToken)
* [copyFromPost](#method-copyFromPost)
* [createLine](#method-createLine)
...
* [initExportFieldList](#method-initExportFieldList)
* [initFooter](#method-initFooter)
* [initHeader](#method-initHeader)
* [initMenu](#method-initMenu)
...
* [run](#method-run)
* [runGlobalExport](#method-runGlobalExport)
* [runReconciliationExport](#method-runReconciliationExport)
...
* [writeExportToFile](#method-writeExportToFile)
...
### <a name="property-$clientPrefix"></a>$clientPrefix

```php
public mixed $clientPrefix = ''
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingExportController.php line 56](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L56).


### <a name="property-$date"></a>$date

```php
public mixed $date = array('begin' => '', 'end' => '')
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingExportController.php line 44](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L44).


### <a name="property-$defaultType"></a>$defaultType

```php
public mixed $defaultType = 'block_global_export'
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingExportController.php line 34](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L34).


### <a name="property-$downloadDir"></a>$downloadDir

```php
public mixed $downloadDir = ''
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingExportController.php line 36](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L36).


### <a name="property-$downloadFile"></a>$downloadFile
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingExportController.php line 38](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L38).


### <a name="property-$exportSelected"></a>$exportSelected

```php
public mixed $exportSelected = ''
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingExportController.php line 40](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L40).


### <a name="property-$exportTypeList"></a>$exportTypeList

```php
public mixed $exportTypeList = array()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingExportController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L30).


### <a name="property-$exportedFilePath"></a>$exportedFilePath

```php
public mixed $exportedFilePath = ''
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingExportController.php line 54](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L54).


### <a name="property-$fd"></a>$fd

```php
public mixed $fd = null
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingExportController.php line 42](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L42).


### <a name="property-$pathTheme"></a>$pathTheme

```php
public mixed $pathTheme = ''
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingExportController.php line 32](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L32).


### <a name="property-$prevent"></a>$prevent

```php
public mixed $prevent = array('errors' => array(), 'warns' => array(), 'hints' => array())
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingExportController.php line 49](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L49).
...
```php
mixed AdminAccountingExportControllerCore::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingExportController.php line 58](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L58)
...
### <a name="method-buildGlobalExportlist"></a>buildGlobalExportlist

```php
array AdminAccountingExportControllerCore::buildGlobalExportlist($db_details)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminAccountingExportController.php line 323](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L323)
...
### <a name="method-checkRights"></a>checkRights

```php
mixed AdminAccountingExportControllerCore::checkRights()
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminAccountingExportController.php line 135](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L135)
...
### <a name="method-createLine"></a>createLine

```php
array AdminAccountingExportControllerCore::createLine($row, $line_number)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminAccountingExportController.php line 279](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L279)
...
### <a name="method-downloadFile"></a>downloadFile

```php
mixed AdminAccountingExportControllerCore::downloadFile($fileName)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminAccountingExportController.php line 465](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L465)
...
```php
mixed AdminAccountingExportControllerCore::initContent()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingExportController.php line 148](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L148)
...
### <a name="method-initExportFieldList"></a>initExportFieldList

```php
mixed AdminAccountingExportControllerCore::initExportFieldList()
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminAccountingExportController.php line 73](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L73)
...
### <a name="method-initMenu"></a>initMenu

```php
mixed AdminAccountingExportControllerCore::initMenu()
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminAccountingExportController.php line 112](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L112)
...
```php
mixed AdminAccountingExportControllerCore::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingExportController.php line 177](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L177)
...
### <a name="method-runGlobalExport"></a>runGlobalExport

```php
mixed AdminAccountingExportControllerCore::runGlobalExport()
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminAccountingExportController.php line 404](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L404)




### <a name="method-runReconciliationExport"></a>runReconciliationExport

```php
mixed AdminAccountingExportControllerCore::runReconciliationExport()
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminAccountingExportController.php line 244](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L244)
...
```php
mixed AdminAccountingExportControllerCore::setMedia()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingExportController.php line 128](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L128)
...
### <a name="method-writeExportToFile"></a>writeExportToFile

```php
mixed AdminAccountingExportControllerCore::writeExportToFile($list)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminAccountingExportController.php line 217](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminAccountingExportController.php#L217)
