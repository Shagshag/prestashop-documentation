...
* Source: [controllers/admin/AdminPdfController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminPdfController.php#L28)
...
* [$encoding_list](#property-$encoding_list)
* [$font_list](#property-$font_list)
...
### <a name="property-$encoding_list"></a>$encoding_list

```php
private mixed $encoding_list = array()
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminPdfController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminPdfController.php#L30).


### <a name="property-$font_list"></a>$font_list

```php
private mixed $font_list = array()
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminPdfController.php line 32](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminPdfController.php#L32).
...
```php
mixed AdminPdfControllerCore::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminPdfController.php line 34](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminPdfController.php#L34)
