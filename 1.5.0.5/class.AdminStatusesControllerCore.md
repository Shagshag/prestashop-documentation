...
* Source: [controllers/admin/AdminStatusesController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatusesController.php#L28)
...
* [displayEditstatusLink](#method-displayEditstatusLink)
...
* [initFormStatus](#method-initFormStatus)
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatusesController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatusesController.php#L30)
...
```php
string AdminStatusesControllerCore::displayEditaddressesLink(string $token, integer $id)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatusesController.php line 165](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatusesController.php#L165)
...
### <a name="method-displayEditstatusLink"></a>displayEditstatusLink

```php
string AdminStatusesControllerCore::displayEditstatusLink(string $token, integer $id)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatusesController.php line 468](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatusesController.php#L468)
...
* Visibility: **protected**
* Source: [controllers/admin/AdminStatusesController.php line 420](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatusesController.php#L420)
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatusesController.php line 440](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatusesController.php#L440)
...
```php
mixed AdminStatusesControllerCore::initContent()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatusesController.php line 448](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatusesController.php#L448)
...
### <a name="method-initFormStatus"></a>initFormStatus

```php
mixed AdminStatusesControllerCore::initFormStatus()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatusesController.php line 337](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatusesController.php#L337)
...
```php
mixed AdminStatusesControllerCore::initToolbar()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatusesController.php line 391](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatusesController.php#L391)
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatusesController.php line 483](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatusesController.php#L483)
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatusesController.php line 180](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatusesController.php#L180)
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatusesController.php line 104](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatusesController.php#L104)
