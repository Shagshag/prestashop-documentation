Class AdminGeneratorControllerCore
=====================
...
* Class name: AdminGeneratorControllerCore
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminGeneratorController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminGeneratorController.php#L28)
...
```php
protected mixed $options = array('array for auto display')
```
...
* Source: [controllers/admin/AdminGeneratorController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminGeneratorController.php#L30).
...
```php
mixed AdminGeneratorControllerCore::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGeneratorController.php line 32](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminGeneratorController.php#L32)
...
```php
mixed AdminGeneratorControllerCore::checkConfiguration($file)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGeneratorController.php line 53](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminGeneratorController.php#L53)
...
```php
mixed AdminGeneratorControllerCore::getRobotsContent()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGeneratorController.php line 133](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminGeneratorController.php#L133)
...
```php
mixed AdminGeneratorControllerCore::initContent()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGeneratorController.php line 42](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminGeneratorController.php#L42)
...
```php
mixed AdminGeneratorControllerCore::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGeneratorController.php line 60](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminGeneratorController.php#L60)
