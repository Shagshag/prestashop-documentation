File admin-dev/functions.php
=========

Source: [admin-dev/functions.php](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/admin-dev/functions.php)
...
* [generateShopList](function.generateShopList.md)
