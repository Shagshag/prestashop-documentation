...
* Parent class: [AdminStatsTabControllerCore](class.AdminStatsTabControllerCore.md)
* Source: [controllers/admin/AdminStatsController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatsController.php#L28)
...
```php
mixed AdminStatsControllerCore::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatsController.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatsController.php#L31)
...
```php
mixed AdminStatsControllerCore::beforeUpdateOptions()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatsController.php line 413](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatsController.php#L413)
...
```php
mixed AdminStatsControllerCore::displayCalendar()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatsController.php line 61](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatsController.php#L61)
...
```php
mixed AdminStatsControllerCore::displayCalendarForm($translations, $token, $action, $table, $identifier, $id)
```
...
* Source: [controllers/admin/AdminStatsController.php line 74](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatsController.php#L74)
...
```php
mixed AdminStatsControllerCore::displayEngines()
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminStatsController.php line 96](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatsController.php#L96)
...
```php
mixed AdminStatsControllerCore::displayMenu()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatsController.php line 121](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatsController.php#L121)
...
```php
mixed AdminStatsControllerCore::displayStats()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatsController.php line 153](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatsController.php#L153)
...
### <a name="method-getConf"></a>getConf

```php
mixed AdminStatsControllerCore::getConf($fields, $languages)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminStatsController.php line 401](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatsController.php#L401)
...
```php
mixed AdminStatsControllerCore::getDate()
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminStatsController.php line 242](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatsController.php#L242)
...
```php
mixed AdminStatsControllerCore::getModules()
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminStatsController.php line 140](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatsController.php#L140)
...
```php
mixed AdminStatsControllerCore::init()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatsController.php line 29](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatsController.php#L29)
...
```php
mixed AdminStatsControllerCore::initContent()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatsController.php line 37](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatsController.php#L37)
...
```php
mixed AdminStatsControllerCore::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatsController.php line 379](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatsController.php#L379)
...
```php
mixed AdminStatsControllerCore::updateOptionPsAttachementMaximumSize($value)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatsController.php line 427](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatsController.php#L427)
...
```php
mixed AdminStatsControllerCore::updateOptionPsB2bEnable($value)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminStatsController.php line 443](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminStatsController.php#L443)
