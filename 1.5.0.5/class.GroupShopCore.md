...
* Class name: GroupShopCore
* Parent class: [ObjectModel](class.ObjectModelCore.md)
* Source: [classes/shop/GroupShop.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L31)
...
* [$assoTables](#property-$assoTables)
...
* [copyGroupShopData](#method-copyGroupShopData)
...
* [getGroupShopById](#method-getGroupShopById)
* [getGroupShops](#method-getGroupShops)
* [getIdByName](#method-getIdByName)
* [getTotalGroupShops](#method-getTotalGroupShops)
...
* Visibility: **public**
* Source: [classes/shop/GroupShop.php line 34](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L34).


### <a name="property-$assoTables"></a>$assoTables

```php
private mixed $assoTables = array('attribute_group' => array('type' => 'group_shop'), 'attribute' => array('type' => 'group_shop'), 'feature' => array('type' => 'group_shop'), 'group' => array('type' => 'group_shop'), 'manufacturer' => array('type' => 'group_shop'), 'supplier' => array('type' => 'group_shop'), 'zone' => array('type' => 'group_shop'), 'tax_rules_group' => array('type' => 'group_shop'))
```
...
* Source: [classes/shop/GroupShop.php line 56](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L56).


### <a name="property-$definition"></a>$definition

```php
public mixed $definition = array('table' => 'group_shop', 'primary' => 'id_group_shop', 'fields' => array('name' => array('type' => self::TYPE_STRING, 'validate' => 'isGenericName', 'required' => true, 'size' => 64), 'share_customer' => array('type' => self::TYPE_BOOL, 'validate' => 'isBool'), 'share_order' => array('type' => self::TYPE_BOOL, 'validate' => 'isBool'), 'share_stock' => array('type' => self::TYPE_BOOL, 'validate' => 'isBool'), 'active' => array('type' => self::TYPE_BOOL, 'validate' => 'isBool'), 'deleted' => array('type' => self::TYPE_BOOL, 'validate' => 'isBool')))
```
...
* Visibility: **public**
* This property is **static**.
* Source: [classes/shop/GroupShop.php line 43](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L43).
...
* Visibility: **public**
* Source: [classes/shop/GroupShop.php line 38](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L38).
...
* Visibility: **public**
* Source: [classes/shop/GroupShop.php line 33](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L33).
...
* Visibility: **public**
* Source: [classes/shop/GroupShop.php line 35](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L35).
...
* Visibility: **public**
* Source: [classes/shop/GroupShop.php line 37](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L37).
...
* Visibility: **public**
* Source: [classes/shop/GroupShop.php line 36](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L36).
...
### <a name="method-copyGroupShopData"></a>copyGroupShopData

```php
mixed GroupShopCore::copyGroupShopData($old_id, $tables_import, $deleted)
```
...
* Visibility: **public**
* Source: [classes/shop/GroupShop.php line 165](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L165)
...
* Visibility: **public**
* Source: [classes/shop/GroupShop.php line 88](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L88)
...
```php
mixed GroupShopCore::getAssoTables()
```
...
* Visibility: **public**
* This method is **static**.
* Source: [classes/shop/GroupShop.php line 106](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L106)
...
* Visibility: **public**
* Source: [classes/shop/GroupShop.php line 71](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L71)
...
### <a name="method-getGroupShopById"></a>getGroupShopById

```php
array GroupShopCore::getGroupShopById(integer $id, string $identifier, string $table)
```
...
* Visibility: **public**
* This method is **static**.
* Source: [classes/shop/GroupShop.php line 154](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L154)
...
### <a name="method-getGroupShops"></a>getGroupShops

```php
mixed GroupShopCore::getGroupShops($active)
```
...
* Visibility: **public**
* This method is **static**.
* Source: [classes/shop/GroupShop.php line 79](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L79)
...
```php
integer GroupShopCore::getIdByName(string $name)
```
...
* Visibility: **public**
* This method is **static**.
* Source: [classes/shop/GroupShop.php line 138](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L138)
...
### <a name="method-getTotalGroupShops"></a>getTotalGroupShops

```php
integer GroupShopCore::getTotalGroupShops($active)
```
...
* Visibility: **public**
* This method is **static**.
* Source: [classes/shop/GroupShop.php line 114](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L114)
...
```php
mixed GroupShopCore::getTotalShops()
```
...
* Visibility: **public**
* Source: [classes/shop/GroupShop.php line 124](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L124)
...
* Visibility: **public**
* Source: [classes/shop/GroupShop.php line 119](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/shop/GroupShop.php#L119)
