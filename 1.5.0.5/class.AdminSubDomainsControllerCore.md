Class AdminSubDomainsControllerCore
=====================
...
* Class name: AdminSubDomainsControllerCore
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminSubDomainsController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminSubDomainsController.php#L28)
...
```php
mixed AdminSubDomainsControllerCore::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminSubDomainsController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminSubDomainsController.php#L30)
...
```php
mixed AdminSubDomainsControllerCore::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminSubDomainsController.php line 75](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminSubDomainsController.php#L75)
...
```php
mixed AdminSubDomainsControllerCore::renderList()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminSubDomainsController.php line 67](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminSubDomainsController.php#L67)
