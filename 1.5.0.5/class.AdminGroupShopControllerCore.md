Class AdminGroupShopControllerCore
=====================
...
* Class name: AdminGroupShopControllerCore
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminGroupShopController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminGroupShopController.php#L28)
...
```php
mixed AdminGroupShopControllerCore::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGroupShopController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminGroupShopController.php#L30)
...
```php
mixed AdminGroupShopControllerCore::afterAdd($new_group_shop)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminGroupShopController.php line 275](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminGroupShopController.php#L275)


#### Arguments
* $new_group_shop **mixed**
...
```php
mixed AdminGroupShopControllerCore::afterUpdate($new_group_shop)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminGroupShopController.php line 284](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminGroupShopController.php#L284)
...
```php
mixed AdminGroupShopControllerCore::getList($id_lang, $order_by, $order_way, $start, $limit, $id_lang_shop)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGroupShopController.php line 244](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminGroupShopController.php#L244)
...
```php
mixed AdminGroupShopControllerCore::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGroupShopController.php line 259](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminGroupShopController.php#L259)
...
```php
mixed AdminGroupShopControllerCore::renderForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminGroupShopController.php line 72](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminGroupShopController.php#L72)
