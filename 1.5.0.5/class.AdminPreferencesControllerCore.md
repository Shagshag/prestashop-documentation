...
* Source: [controllers/admin/AdminPreferencesController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminPreferencesController.php#L28)
...
* Visibility: **public**
* Source: [controllers/admin/AdminPreferencesController.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminPreferencesController.php#L31)
...
```php
mixed AdminPreferencesControllerCore::beforeUpdateOptions()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminPreferencesController.php line 413](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminPreferencesController.php#L413)
...
```php
mixed AdminPreferencesControllerCore::getConf($fields, $languages)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminPreferencesController.php line 401](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminPreferencesController.php#L401)
...
```php
mixed AdminPreferencesControllerCore::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminPreferencesController.php line 379](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminPreferencesController.php#L379)
...
```php
mixed AdminPreferencesControllerCore::updateOptionPsAttachementMaximumSize($value)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminPreferencesController.php line 427](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminPreferencesController.php#L427)
...
```php
mixed AdminPreferencesControllerCore::updateOptionPsB2bEnable($value)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminPreferencesController.php line 443](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminPreferencesController.php#L443)
