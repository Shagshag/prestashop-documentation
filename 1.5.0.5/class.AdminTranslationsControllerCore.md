...
* Source: [controllers/admin/AdminTranslationsController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L30)
...
* [$php_regexp](#property-$php_regexp)
* [$suhosin_limit_exceed](#property-$suhosin_limit_exceed)
* [$total_expression](#property-$total_expression)
* [$tpl_regexp](#property-$tpl_regexp)
...
* [_parsePdfClass](#method-_parsePdfClass)
...
* [getThemesList](#method-getThemesList)
...
* Source: [controllers/admin/AdminTranslationsController.php line 36](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L36).
...
```php
protected mixed $all_iso_lang = array()
```
...
* Source: [controllers/admin/AdminTranslationsController.php line 34](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L34).


### <a name="property-$link_lang_pack"></a>$link_lang_pack

```php
protected mixed $link_lang_pack = 'http://www.prestashop.com/download/lang_packs/get_each_language_pack.php'
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 32](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L32).


### <a name="property-$modules_translations"></a>$modules_translations

```php
protected mixed $modules_translations = array()
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 35](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L35).


### <a name="property-$php_regexp"></a>$php_regexp

```php
protected mixed $php_regexp = ''
```
...
* Source: [controllers/admin/AdminTranslationsController.php line 38](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L38).


### <a name="property-$suhosin_limit_exceed"></a>$suhosin_limit_exceed

```php
protected boolean $suhosin_limit_exceed = false
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 45](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L45).


### <a name="property-$total_expression"></a>$total_expression

```php
protected mixed $total_expression
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 33](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L33).


### <a name="property-$tpl_regexp"></a>$tpl_regexp

```php
protected mixed $tpl_regexp = ''
```
...
* Visibility: **protected**
* This property is **static**.
* Source: [controllers/admin/AdminTranslationsController.php line 37](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L37).
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 47](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L47)
...
### <a name="method-_parsePdfClass"></a>_parsePdfClass

```php
array AdminTranslationsControllerCore::_parsePdfClass(string $filepath, string $regex, array $langArray, string $tab, array $tabs_array)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 1751](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1751)


#### Arguments
* $filepath **string** - file to parse
* $regex **string** - regexp to use
* $langArray **array** - contains expression in the chosen language
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 238](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L238)
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 268](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L268)
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 162](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L162)
...
```php
mixed AdminTranslationsControllerCore::clearModuleFiles($files, $type_clear, $path)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 413](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L413)
...
* Visibility: **protected**
* This method is defined by [AdminControllerCore](class.AdminControllerCore.md).
* Source: [classes/controller/AdminController.php line 2291](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/controller/AdminController.php#L2291)
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 810](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L810)
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 1380](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1380)
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 1359](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1359)
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 1286](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1286)
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 785](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L785)
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 768](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L768)
...
```php
mixed AdminTranslationsControllerCore::fileExists(string $dir, string $file, string $var)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 753](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L753)


#### Arguments
* $dir **string**
* $file **string**
* $var **string** - var to return (_LANGADM, _LANG, _FIELDS, _ERRORS)
return array
...
```php
void AdminTranslationsControllerCore::findAndFillTranslations(array $files, string $theme_name, string $module_name, string|boolean $dir, string $iso_code)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 441](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L441)
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 358](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L358)
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 1671](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1671)
...
* Visibility: **public**
* This method is defined by [AdminControllerCore](class.AdminControllerCore.md).
* Source: [classes/controller/AdminController.php line 1910](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/controller/AdminController.php#L1910)
...
```php
mixed AdminTranslationsControllerCore::getMailContent(string $dir, string $file, string $lang)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 1265](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1265)


#### Arguments
* $dir **string**
* $file **string**
* $lang **string** - iso code of a language
...
```php
mixed AdminTranslationsControllerCore::getMailFiles(string $dir, string $lang, $group_name)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 1218](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1218)
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 625](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L625)
...
```php
mixed AdminTranslationsControllerCore::getModuleTranslations(boolean $is_default)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 132](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L132)


#### Arguments
* $is_default **boolean** - if true a prefix is set before each keys in global $_MODULES array
...
```php
array AdminTranslationsControllerCore::getModulesHasMails()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 1429](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1429)
...
```php
mixed AdminTranslationsControllerCore::getSubjectMail($directory, $subject_mail)
```
...
* Visibility: **protected**
* This method is **static**.
* Source: [controllers/admin/AdminTranslationsController.php line 1552](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1552)
...
```php
mixed AdminTranslationsControllerCore::getSubjectMailContent($directory)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 1584](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1584)
...
### <a name="method-getThemesList"></a>getThemesList

```php
array AdminTranslationsControllerCore::getThemesList()
```
...
* Visibility: **public**
* This method is **static**.
* Source: [controllers/admin/AdminTranslationsController.php line 1842](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1842)
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 1437](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1437)
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 797](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L797)
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 60](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L60)
...
```php
mixed AdminTranslationsControllerCore::initFormBack($lang)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 901](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L901)
...
```php
mixed AdminTranslationsControllerCore::initFormErrors($lang)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 1079](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1079)
...
```php
mixed AdminTranslationsControllerCore::initFormFields($lang)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 1135](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1135)
...
```php
mixed AdminTranslationsControllerCore::initFormFront($lang)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 829](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L829)
...
```php
mixed AdminTranslationsControllerCore::initFormMails($lang, $noDisplay)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 1459](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1459)
...
```php
mixed AdminTranslationsControllerCore::initFormModules($lang)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 1690](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1690)
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 1760](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1760)
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 82](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L82)
...
* Visibility: **public**
* This method is defined by [AdminControllerCore](class.AdminControllerCore.md).
* Source: [classes/controller/AdminController.php line 1756](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/controller/AdminController.php#L1756)
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 70](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L70)
...
* Visibility: **public**
* This method is defined by [AdminControllerCore](class.AdminControllerCore.md).
* Source: [classes/controller/AdminController.php line 314](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/controller/AdminController.php#L314)
...
```php
mixed AdminTranslationsControllerCore::listFiles($dir, $list)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 1854](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1854)
...
* Visibility: **protected**
* This method is defined by [AdminControllerCore](class.AdminControllerCore.md).
* Source: [classes/controller/AdminController.php line 1012](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/controller/AdminController.php#L1012)
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 488](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L488)
...
* Visibility: **public**
* This method is defined by [AdminControllerCore](class.AdminControllerCore.md).
* Source: [classes/controller/AdminController.php line 599](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/controller/AdminController.php#L599)
...
* Visibility: **protected**
* This method is defined by [AdminControllerCore](class.AdminControllerCore.md).
* Source: [classes/controller/AdminController.php line 2460](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/controller/AdminController.php#L2460)
...
* Visibility: **public**
* This method is defined by [AdminControllerCore](class.AdminControllerCore.md).
* Source: [classes/controller/AdminController.php line 531](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/controller/AdminController.php#L531)
...
* Visibility: **public**
* This method is defined by [AdminControllerCore](class.AdminControllerCore.md).
* Source: [classes/controller/AdminController.php line 779](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/controller/AdminController.php#L779)
...
* Visibility: **public**
* This method is defined by [AdminControllerCore](class.AdminControllerCore.md).
* Source: [classes/controller/AdminController.php line 646](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/controller/AdminController.php#L646)
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 1639](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1639)
...
* Visibility: **public**
* This method is defined by [AdminControllerCore](class.AdminControllerCore.md).
* Source: [classes/controller/AdminController.php line 1458](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/controller/AdminController.php#L1458)
...
* Visibility: **public**
* This method is defined by [AdminControllerCore](class.AdminControllerCore.md).
* Source: [classes/controller/AdminController.php line 1411](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/controller/AdminController.php#L1411)
...
* Visibility: **public**
* This method is defined by [AdminControllerCore](class.AdminControllerCore.md).
* Source: [classes/controller/AdminController.php line 1561](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/classes/controller/AdminController.php#L1561)
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 310](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L310)
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 202](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L202)
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 253](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L253)
...
* Visibility: **public**
* Source: [controllers/admin/AdminTranslationsController.php line 287](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L287)
...
```php
mixed AdminTranslationsControllerCore::submitTranslationsMails(integer $id_lang)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 647](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L647)
...
```php
mixed AdminTranslationsControllerCore::writeSubjectTranslationFile($sub, $path, $mark, $fullmark)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 1605](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L1605)
...
```php
mixed AdminTranslationsControllerCore::writeTranslationFile($type, $path, $mark, $fullmark)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminTranslationsController.php line 179](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminTranslationsController.php#L179)
