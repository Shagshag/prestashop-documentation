Class AdminContactControllerCore
=====================
...
* Class name: AdminContactControllerCore
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminContactController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminContactController.php#L28)
...
```php
mixed AdminContactControllerCore::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminContactController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminContactController.php#L30)
...
```php
mixed AdminContactControllerCore::_buildOrderedFieldsShop($formFields)
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminContactController.php line 69](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminContactController.php#L69)
...
```php
mixed AdminContactControllerCore::_getDefaultFieldsContent()
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminContactController.php line 41](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminContactController.php#L41)
...
```php
mixed AdminContactControllerCore::beforeUpdateOptions()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminContactController.php line 103](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminContactController.php#L103)
...
```php
mixed AdminContactControllerCore::updateOptionPsShopCountryId($value)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminContactController.php line 116](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminContactController.php#L116)
...
```php
mixed AdminContactControllerCore::updateOptionPsShopStateId($value)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminContactController.php line 129](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminContactController.php#L129)
