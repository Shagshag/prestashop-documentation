...
* Source: [controllers/admin/AdminCmsCategoriesController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminCmsCategoriesController.php#L28)
...
* [$_CMSCategory](#property-$_CMSCategory)
...
### <a name="property-$_CMSCategory"></a>$_CMSCategory

```php
private object $_CMSCategory
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminCmsCategoriesController.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminCmsCategoriesController.php#L31).
...
* Visibility: **public**
* Source: [controllers/admin/AdminCmsCategoriesController.php line 33](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminCmsCategoriesController.php#L33)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCmsCategoriesController.php line 66](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminCmsCategoriesController.php#L66)
...
```php
mixed AdminCmsCategoriesControllerCore::postProcess($token)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminCmsCategoriesController.php line 76](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminCmsCategoriesController.php#L76)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCmsCategoriesController.php line 177](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminCmsCategoriesController.php#L177)
...
* Visibility: **public**
* Source: [controllers/admin/AdminCmsCategoriesController.php line 57](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.5/controllers/admin/AdminCmsCategoriesController.php#L57)
