...
* Class name: ModuleControllerCore
* Parent class: [FrontController](class.FrontControllerCore.md)
* Source: [controllers/front/ModuleController.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/controllers/front/ModuleController.php#L31)
...
* Visibility: **public**
* Source: [controllers/front/ModuleController.php line 36](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/controllers/front/ModuleController.php#L36).
...
```php
mixed ModuleControllerCore::__construct()
```
...
* Visibility: **public**
* Source: [controllers/front/ModuleController.php line 38](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/controllers/front/ModuleController.php#L38)
...
```php
mixed ModuleControllerCore::setTemplate(string $template)
```
...
* Visibility: **public**
* Source: [controllers/front/ModuleController.php line 53](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/controllers/front/ModuleController.php#L53)
