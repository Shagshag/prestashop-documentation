...
* Source: [classes/SubDomain.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/classes/SubDomain.php#L28)
...
```php
public mixed $definition = array('table' => 'subdomain', 'primary' => 'id_subdomain', 'fields' => array('name' => array('type' => self::TYPE_STRING, 'validate' => 'isSubDomainName', 'required' => true, 'size' => 16)))
```
...
* Source: [classes/SubDomain.php line 35](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/classes/SubDomain.php#L35).
...
* Visibility: **public**
* Source: [classes/SubDomain.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/classes/SubDomain.php#L30).
...
* Visibility: **public**
* This method is **static**.
* Source: [classes/SubDomain.php line 43](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/classes/SubDomain.php#L43)
