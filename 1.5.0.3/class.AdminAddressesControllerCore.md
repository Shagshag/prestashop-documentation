...
* Source: [controllers/admin/AdminAddressesController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/controllers/admin/AdminAddressesController.php#L28)
...
* [$countriesArray](#property-$countriesArray)
...
### <a name="property-$countriesArray"></a>$countriesArray

```php
private array $countriesArray = array()
```
...
* Visibility: **private**
* Source: [controllers/admin/AdminAddressesController.php line 31](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/controllers/admin/AdminAddressesController.php#L31).
...
* Visibility: **public**
* Source: [controllers/admin/AdminAddressesController.php line 33](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/controllers/admin/AdminAddressesController.php#L33)
...
* Visibility: **protected**
* Source: [controllers/admin/AdminAddressesController.php line 364](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/controllers/admin/AdminAddressesController.php#L364)
...
* Visibility: **public**
* Source: [controllers/admin/AdminAddressesController.php line 281](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/controllers/admin/AdminAddressesController.php#L281)
...
* Visibility: **public**
* Source: [controllers/admin/AdminAddressesController.php line 77](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/controllers/admin/AdminAddressesController.php#L77)
...
* Visibility: **public**
* Source: [controllers/admin/AdminAddressesController.php line 63](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/controllers/admin/AdminAddressesController.php#L63)
