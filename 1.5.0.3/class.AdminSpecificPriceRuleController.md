Class AdminSpecificPriceRuleController
=====================
...
* Class name: AdminSpecificPriceRuleController
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminSpecificPriceRuleController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/controllers/admin/AdminSpecificPriceRuleController.php#L28)
...
* Visibility: **public**
* Source: [controllers/admin/AdminSpecificPriceRuleController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/controllers/admin/AdminSpecificPriceRuleController.php#L30).
...
```php
mixed AdminSpecificPriceRuleController::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminSpecificPriceRuleController.php line 32](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/controllers/admin/AdminSpecificPriceRuleController.php#L32)
...
```php
mixed AdminSpecificPriceRuleController::getList($id_lang, $order_by, $order_way, $start, $limit, $id_lang_shop)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminSpecificPriceRuleController.php line 110](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/controllers/admin/AdminSpecificPriceRuleController.php#L110)
...
```php
mixed AdminSpecificPriceRuleController::processSave($token)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminSpecificPriceRuleController.php line 264](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/controllers/admin/AdminSpecificPriceRuleController.php#L264)
...
```php
mixed AdminSpecificPriceRuleController::renderForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminSpecificPriceRuleController.php line 121](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.3/controllers/admin/AdminSpecificPriceRuleController.php#L121)
