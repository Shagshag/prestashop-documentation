Class AdminAccountingRegisteredNumberControllerCore
=====================
...
* Class name: AdminAccountingRegisteredNumberControllerCore
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminAccountingRegisteredNumberController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.9/controllers/admin/AdminAccountingRegisteredNumberController.php#L28)
...
* [$account_number_list](#property-$account_number_list)
...
* [getAccountingNumberConfiguration](#method-getAccountingNumberConfiguration)
...
* [init](#method-init)
* [initAccountNumberList](#method-initAccountNumberList)
...
### <a name="property-$account_number_list"></a>$account_number_list

```php
public mixed $account_number_list = array()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingRegisteredNumberController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.9/controllers/admin/AdminAccountingRegisteredNumberController.php#L30).
...
```php
mixed AdminAccountingRegisteredNumberControllerCore::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingRegisteredNumberController.php line 32](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.9/controllers/admin/AdminAccountingRegisteredNumberController.php#L32)
...
### <a name="method-getAccountingNumberConfiguration"></a>getAccountingNumberConfiguration

```php
array AdminAccountingRegisteredNumberControllerCore::getAccountingNumberConfiguration(string $key)
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingRegisteredNumberController.php line 152](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.9/controllers/admin/AdminAccountingRegisteredNumberController.php#L152)


#### Arguments
* $key **string** - of the Accounting configuration
...
### <a name="method-initAccountNumberList"></a>initAccountNumberList

```php
mixed AdminAccountingRegisteredNumberControllerCore::initAccountNumberList()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingRegisteredNumberController.php line 159](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.9/controllers/admin/AdminAccountingRegisteredNumberController.php#L159)
...
```php
mixed AdminAccountingRegisteredNumberControllerCore::initContent()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingRegisteredNumberController.php line 132](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.9/controllers/admin/AdminAccountingRegisteredNumberController.php#L132)
...
```php
mixed AdminAccountingRegisteredNumberControllerCore::initToolbar()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingRegisteredNumberController.php line 126](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.9/controllers/admin/AdminAccountingRegisteredNumberController.php#L126)
