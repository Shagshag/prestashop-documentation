Class AdminAccountingConfigurationControllerCore
=====================
...
* Class name: AdminAccountingConfigurationControllerCore
* Parent class: [AdminController](class.AdminControllerCore.md)
* Source: [controllers/admin/AdminAccountingConfigurationController.php line 28](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.9/controllers/admin/AdminAccountingConfigurationController.php#L28)
...
* [init](#method-init)
* [initAccountZoneShop](#method-initAccountZoneShop)
* [initAccountingForm](#method-initAccountingForm)
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingConfigurationController.php line 30](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.9/controllers/admin/AdminAccountingConfigurationController.php#L30).


### <a name="property-$fields_list"></a>$fields_list

```php
public mixed $fields_list = array()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingConfigurationController.php line 32](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.9/controllers/admin/AdminAccountingConfigurationController.php#L32).
...
```php
mixed AdminAccountingConfigurationControllerCore::__construct()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingConfigurationController.php line 34](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.9/controllers/admin/AdminAccountingConfigurationController.php#L34)
...
### <a name="method-initAccountZoneShop"></a>initAccountZoneShop

```php
mixed AdminAccountingConfigurationControllerCore::initAccountZoneShop()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingConfigurationController.php line 51](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.9/controllers/admin/AdminAccountingConfigurationController.php#L51)




### <a name="method-initAccountingForm"></a>initAccountingForm

```php
mixed AdminAccountingConfigurationControllerCore::initAccountingForm()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingConfigurationController.php line 92](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.9/controllers/admin/AdminAccountingConfigurationController.php#L92)
...
```php
mixed AdminAccountingConfigurationControllerCore::initContent()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingConfigurationController.php line 168](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.9/controllers/admin/AdminAccountingConfigurationController.php#L168)
...
```php
mixed AdminAccountingConfigurationControllerCore::initToolbar()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingConfigurationController.php line 42](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.9/controllers/admin/AdminAccountingConfigurationController.php#L42)
...
```php
mixed AdminAccountingConfigurationControllerCore::postProcess()
```
...
* Visibility: **public**
* Source: [controllers/admin/AdminAccountingConfigurationController.php line 187](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.9/controllers/admin/AdminAccountingConfigurationController.php#L187)
...
```php
mixed AdminAccountingConfigurationControllerCore::updateAccountNumber()
```
...
* Visibility: **protected**
* Source: [controllers/admin/AdminAccountingConfigurationController.php line 206](https://github.com/PrestaShop/PrestaShop/blob/1.5.0.9/controllers/admin/AdminAccountingConfigurationController.php#L206)
